...
<body>
	...
	<script type="text/javascript">
		...
		function carregarAlteracao(id) {
			...
			$.post("${baseURL}/rest/json/professor", {"id" : id}).done(function(response) {
				...
				$("#texto-modal").html("Erro ao tentar carregar os dados do professor para serem alterados. Por gentileza tente novamente!");
				$("#modal").modal("show");
			});
		}
	</script>
